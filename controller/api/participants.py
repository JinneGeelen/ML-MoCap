...
from controllers import participant_controller as controller
...
class WebsocketConnections(WebSocketEndpoint):
  ...
  async def on_connect(self, websocket):
    ...
    logger.info('Frontent application subscribed to participant updates...')

  async def on_disconnect(self, websocket, close_code):
    await controller.unsubscribe(websocket)
    logger.info('Frontent application unsubscribed to participant updates...')
